...
<h1><center>Recent Matches</center></h1>

<div id="myBtnContainer">
 <br> <button class="btn active" onclick="filterSelection('all')"> All Recent Matches</button></br></br>
...
<div class="container">
    <a href="indvspak.htm"class="filterDiv ind pak"><input type = "button" id ="btn" value  = "Ind Vs Pak" /></a>
    <a href="nzvsaus.htm"class="filterDiv aus nz"><input type = "button" id ="btn" value  = "Aus Vs NZ" /></a>
    <a href="index.html"class="filterDiv sa eng"><input type = "button" id ="btn" value  = "Eng Vs SA" /></a>
